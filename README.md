...
WhatsApp agent using AgentFunctionBackend + LLMClient pattern. Handles WhatsApp conversations with dynamic tool loading.
...
- The function name matches "WhatsappAgentLlmFn"
...
- AWS CloudWatch Logs: `/aws/lambda/WhatsappAgentLlmFn`
- Chask dashboard: Organization → Functions → WhatsappAgentLlmFn
